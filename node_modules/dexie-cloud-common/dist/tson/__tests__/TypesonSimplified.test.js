...
describe('TypesonSimplified', () => {
    ...
    describe('primitive types', () => {
        ...
        test('should not stringify undefined in objects (default behavior)', () => {
            ...
            expect(TSON.stringify({ foo: null, bar: undefined })).toBe(JSON.stringify({ foo: null }));
        });
    });
    describe('$ escaping', () => {
    ...
    describe('BigInt', () => {
        ...
        test('handles array of BigInts including special values', () => {
            const golem96 = (BigInt(2882343476) << BigInt(64)) |
                (BigInt(39030) << BigInt(32)) |
                BigInt(2290644854);
            ...
            expect(tson).toBe(JSON.stringify([
                { $t: 'bigint', v: '0' },
                { $t: 'bigint', v: '1' },
                { $t: 'bigint', v: '-1' },
                { $t: 'bigint', v: '16' },
